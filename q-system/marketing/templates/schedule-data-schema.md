...
{
  "id": "jane",
  "title": "Reply to Jane Doe (Acme Ventures) - he wants RSA meeting Mar 25",
  "energy": "quickwin",
  "time": "2 min",
  "platform": "Email",
  "badge": null,
  "extraTags": [],
  "daysAgo": null,
  "context": "<span style='color:#34d399'>He replied!</span> \"Thanks. Let's find time Wednesday March 25.\"",
  "links": [
    {"text": "Open email", "url": "mailto:jane@example.com?subject=Re:%20RSA"}
  ],
  "copyBlocks": [
    {
  ...
  "sections": [
    {
      ...
      "items": [
        {
          "id": "jane-reply",
          "title": "Reply to Jane Doe (Acme Ventures) - RSA meeting Mar 25",
          "energy": "quickwin",
          "time": "2 min",
          "platform": "Email",
          "badge": "WIN",
          "context": "<span style='color:#34d399'>He replied!</span> Wants to meet Wed Mar 25 at RSA.",
          "links": [{"text": "Open email", "url": "mailto:jane@example.com"}],
          "copyBlocks": [
            {
              "label": "Email Reply",
              "text": "No worries at all. Wednesday March 25 works great.\n\nYou"
        ...
        {
          "id": "comment-mamica",
          "title": "Comment on Michelle Example's post - alert fatigue",
          "energy": "quickwin",
          "time": "2 min",
          "platform": "LinkedIn",
    ...
    },
    {
      ...
      "collapsed": true,
      "infoNotes": [
        "<strong>Acme Ventures:</strong> Back on track. RSA meeting Mar 25.",
